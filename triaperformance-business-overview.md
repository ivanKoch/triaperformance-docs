...
*Last updated: August 10, 2026. Update this file whenever the numbers move — every other document assumes this one is current.*
...
| Passive plans | $847 | 303 listings | Standard TP marketplace terms | 164 Spanish, 110 English, 29 Portuguese. Near-zero hours invested in H1 2026. |
...
- **Interactive tools** — ***the members library was rebuilt on August 13, 2026 and now stands at eight entries in each of three languages: six interactive tools, one guide, one downloads page.*** *(Rewritten that day. This paragraph previously read "nine are live" and listed as unbuilt several things that now exist.)*

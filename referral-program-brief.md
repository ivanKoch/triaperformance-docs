...
> 🚨 ***September 4, 2026 — the TrainingPeaks Premium inclusion below is no longer a referral differentiator.*** *Iván changed the coaching offer that day: **Premium is now included for every 1:1 athlete**, not only referred ones (owner: `triaperformance-pricing-and-positioning.md` §TrainingPeaks Premium, where the old "must NOT be added to the coaching page" rule is struck).* **This program's reward is now the $50 gift card and nothing else.**
>
> ⚠️ **Two things follow and neither is done.** *(1)* **The LTV arithmetic below is now wrong in the same direction for every athlete**, not just referred ones — *the $134.79/month net figure was $143.79 less the $9 Premium Iván bought "for referred athletes specifically", and that parenthetical no longer describes anything.* *(2)* **The founding-member pitch loses its concrete half.** *"I have one more thing to sell" was Iván's own framing for why Premium worked here; it is now something everyone already has.* **The program either needs a new differentiator or has to stand on the gift card alone — decide before the disclosure message goes out, because the message is what makes the promise.**

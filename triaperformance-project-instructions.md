...
- `lead-magnet-sesiones-por-zona.md` — **home doc for the guide itself** (content, zone-model corrections, CTA decisions). The PDF is generated by `automation/build-lead-magnet-pdf.js`; `data/zones.csv` owns every percentage in it.

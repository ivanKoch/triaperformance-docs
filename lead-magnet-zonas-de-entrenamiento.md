...
*Related and separate: the Spanish-only legacy guides — same vintage, same 20×-too-large problem. All four are now withdrawn: the nutrition pair in September 2026 and the mental pair on September 11, 2026, each replaced by a generated three-language guide. This line used to point at a Backlog item; that item no longer exists, and the work it described is done.*

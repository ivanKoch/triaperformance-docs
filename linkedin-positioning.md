...
- ~~"Grew revenue 670% in year two, and surpassed that full-year mark within the first seven months of year three."~~ **REINSTATED and SOURCED, September 5, 2026 — Iván exported TrainingPeaks' own payout history and the claim is true and understated.** *Source file: `data/revenue_history.csv` (44 months, three channels, net earnings). Owner of the derived figures: `triaperformance-business-overview.md` §Revenue history.*
  **What the file actually produces:** year one (2023) **$1,350** → year two (2024) **$10,440** = **+673%**, so the original number was right. 🚨 ***The second half of the sentence was wrong in the conservative direction: year three passed year two's full-year total in FIVE months, not seven*** (cumulative 2025 crossed $10,440 in May at $12,429). *Year three closed at **$37,070**, another **+255%**.*
  **The line to use, and why it is stronger than the old one:** *"Grew revenue 673% in year two and 255% in year three — 27× over two years — then passed the previous full year inside five months."* ⚠️ **Do not extend the streak into 2026.** *Eight complete months are **$32,542**, 88% of 2025's full year — a fourth consecutive record year is likely and is not yet a fact, and this profile's pitch is that its numbers are re-derivable.*
  *The lesson worth keeping: the figure was removed on September 4 for being unsourceable and the source was one export away. **Removing an unsourced claim is right; assuming it is unsourceable is not** — the question to ask first is which system already holds it.*
...
~~**Open:** Iván adds the URL to the LinkedIn Featured section and to the two copy blocks above. Deploy is the normal cron pull/rsync.~~ **DONE September 5, 2026** — deployed, the three copy blocks pasted into LinkedIn, and `/ai-systems/` added to the Featured section.

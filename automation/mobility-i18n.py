...
"¿De qué vienes?": "What are you coming off?",
"Correr": "Running",
"Bici": "Riding",
"Nadar": "Swimming",
...
"Alcanza con una colchoneta y una pared. Si tienes rodillo o pelota, algunos ejercicios ofrecen esa versión con el botón":
...
# --- cues ---
"Punta del pie contra la pared, talón en el piso, y <strong>lleva la rodilla hacia la pared manteniéndola flexionada</strong>. Rodilla doblada es sóleo, y el sóleo es el que se come la carga cuando corres. Si lo sientes en la vientre del gemelo, dobla más la rodilla.":
...
"Sentado, el gemelo sobre el rodillo y la otra pierna cruzada encima para cargar. <strong>Párate 20 segundos en el punto que más se queja</strong> en vez de ir y venir rápido.":
...
"Agárrate por detrás del muslo y <strong>estira la rodilla hasta donde llegue sin que la cadera se despegue del piso</strong>. La otra pierna queda apoyada. La punta del pie hacia ti solo al final, no desde el principio.":
...
"Toalla en la planta del pie, pierna extendida hacia el techo. <strong>Tira desde la toalla, no desde el cuello.</strong>":
  "Towel around the sole, leg extended toward the ceiling. <strong>Pull from the towel, not from your neck.</strong>",
"Cruza un tobillo sobre la rodilla contraria y trae la pierna de abajo hacia el pecho. <strong>Empuja suave la rodilla cruzada hacia afuera con el codo.</strong> Empieza por el lado que sientes más rígido.":
...
"Sentado sobre la pelota, busca el punto del glúteo que se queja y <strong>quédate quieto ahí respirando</strong> en vez de rodar. Cruza el tobillo sobre la rodilla para llegar más profundo.":
...
"Media rodilla, pie de adelante plano. <strong>Mete la pelvis y aprieta fuerte el glúteo de atrás antes de avanzar</strong> — sin ese apriete estás estirando la lumbar y no el psoas. Ese apriete es el ejercicio.":
...
"De costado, agarra el tobillo de arriba y lleva el talón al glúteo <strong>con la pelvis metida y la rodilla apuntando al piso</strong>, no abierta hacia afuera. Si la lumbar se arquea, afloja el rango.":
...
"Boca abajo, el muslo sobre el rodillo, del pliegue de la cadera hasta arriba de la rodilla. <strong>Presión media: si tienes que aguantar la respiración, es demasiada.</strong>":
...
"De rodillas de espaldas a la pared, el empeine apoyado en ella. <strong>Mete la pelvis antes de subir el tronco</strong> — casi nadie necesita subir tanto como cree.":
...
"Boca arriba, lleva una rodilla cruzada al lado opuesto <strong>dejando que la pelvis rote con ella</strong>, brazos abiertos. Buscas el tensor y el glúteo, por fuera de la cadera. <strong>La cintilla iliotibial no se estira ni se ablanda a golpes: lo que se afloja es lo que tira de ella.</strong>":
...
"El rodillo justo debajo del hueso de la cadera por fuera, y después en el lateral del muslo. <strong>Presión moderada y lenta.</strong> No busques la cintilla: busca el músculo de arriba y el de adelante-afuera.":
...
"De rodillas, una pierna estirada al costado con el pie apoyado, y <strong>lleva la cadera hacia atrás y hacia el lado contrario</strong>. Espalda larga. Es el aductor largo, que en carrera y en bici trabaja mucho más de lo que nadie cree.":
...
"Plantas de los pies juntas, y <strong>inclínate desde la cadera con la espalda larga</strong> — no redondees para llegar más abajo, que es puro engaño. Los codos pueden empujar suave las rodillas.":
...
"Sentado sobre los talones con los dedos de los pies flexionados hacia adelante — si es mucho, apoya las manos y saca peso. Después abre y cierra los dedos. <strong>La fascia plantar se endurece después de correr y nadie la toca hasta que duele.</strong>":
...
"Rueda la planta del pie sobre la pelota, del talón a los dedos, lento, <strong>frenando en los puntos que se quejan</strong>. Presión que puedas sostener respirando normal.":
...
"Sentado sobre los talones con los empeines planos en el piso, <strong>y sube apenas las rodillas para cargar el empeine</strong>. Después, círculos amplios de tobillo. Si vienes de nadar, un tobillo que no apunta frena la patada; si vienes de correr, es el que se te puso duro.":
...
"En cuadrupedia, el rodillo sobre la parte de adelante de la tibia, y rueda despacio de la rodilla al tobillo. Zona sensible: <strong>menos presión de la que crees.</strong>":
...
"Sentado sobre los talones, brazos largos adelante, frente al piso. <strong>Respira hacia la espalda baja</strong> y deja que la cadera baje un poco más con cada exhalación. Aquí el objetivo es bajar pulsaciones, no estirar más.":
...
"Desde la postura del niño, camina las manos hacia un costado hasta sentir el dorsal por el lateral del tronco. <strong>La cadera se queda atrás</strong>, no la sigas con el tronco.":
...
"Rodilla cruzada al lado opuesto, brazos abiertos, mirada al lado contrario. <strong>El hombro no se despega del piso</strong> — si se despega, baja la rodilla. Suelta un poco más en cada exhalación.":
...
"Boca abajo, codos debajo de los hombros, pelvis pesada en el piso. <strong>Es una extensión suave y sostenida, no una cobra.</strong> Si te aprieta la lumbar, lleva los codos más adelante hasta que deje de apretar.":
...
"De costado, rodillas flexionadas y apiladas, brazos juntos adelante. <strong>Abre el brazo de arriba siguiendo la mano con la mirada, y deja las rodillas quietas.</strong> Si las rodillas se separan, la rotación se te fue a la lumbar.":
...
"En cuadrupedia, alterna redondear y arquear al ritmo de la respiración. <strong>Vértebra por vértebra</strong>, no en bloque. Lento: post-entreno esto es para soltar, no para movilizar fuerte.":
...
"De rodillas, antebrazos apoyados adelante y los glúteos hacia los talones. <strong>Hunde el pecho hacia el piso dejando que se abran las axilas.</strong> El movimiento es de la espalda alta: si se arquea la lumbar, acerca más los glúteos a los talones.":
...
"Lleva el brazo cruzado por delante del pecho y <strong>empuja desde el codo, nunca desde la muñeca</strong>. La clave: baja el omóplato y no dejes que el hombro se vaya adelante. Si se va adelante, estás moviendo la escápula en vez de soltar la parte de atrás del hombro.":
...
"Boca abajo, un brazo extendido en cruz a la altura del hombro, y rueda el cuerpo hacia ese lado apoyando el pie contrario. <strong>Busca el pecho, no el frente del hombro</strong> — si lo sientes dentro de la articulación, baja el brazo unos centímetros y vuelve a probar.":
...
"Codo arriba junto a la oreja, mano entre los omóplatos, y empuja suave el codo con la otra mano. <strong>Costillas abajo</strong> — si la lumbar se arquea, ganaste rango con la espalda y no con el hombro.":
...
"Sentado, la mano del lado que estiras sujeta el borde de la colchoneta, y lleva la oreja al hombro contrario <strong>sin encoger el hombro</strong>. No tires con la otra mano: el peso de la cabeza alcanza y sobra.":
...
"En cuadrupedia, gira la mano hasta que los dedos apunten a las rodillas y <strong>siéntate lento hacia atrás</strong>. Después gira la mano y apoya el dorso para el otro lado. Horas agarrado al manillar se pagan aquí.":
...
"Glúteos cerca de la pared, piernas verticales apoyadas en ella, brazos al costado. <strong>Dos minutos enteros, y no estás estirando nada: estás bajando pulsaciones y sacándote el peso de las piernas.</strong> Si tira mucho de los isquios, aleja los glúteos de la pared.":
...
"Boca arriba, rodillas dobladas, una mano en el pecho y otra en el abdomen. <strong>Inhala 4 segundos por la nariz llevando el aire al abdomen, exhala 6 por la boca.</strong> La exhalación larga es la que baja el sistema nervioso, y es lo que convierte esto en recuperación y no en una entrada en calor tardía. Si quieres un protocolo con timer, tienes <a href=\\\"/members/respiracion/\\\">Respiración en caja</a>.":
...
"Cadena posterior, psoas y glúteo, que es lo que te acaba de trabajar. Sostienes cada posición, no rebotas.":
  "Posterior chain, hip flexors and glutes — what you just worked. You hold each position; you do not bounce.",
"Abrir lo que la posición de bici cerró: cadera, pecho y espalda alta. Sostienes cada posición, no rebotas.":
...
"Correr deja el sóleo y los isquios con tono alto y el psoas corto, y después te sientas ocho horas encima de eso. Diez minutos en el piso ahora valen más que media hora mañana, porque el tejido todavía está caliente y todavía te acuerdas de qué te molestó.":
...
"Nadar deja el dorsal y el pectoral menor tirando del hombro hacia adelante, que es exactamente la posición desde la que se pincha. Y deja las piernas afuera de la conversación: pateaste una hora con el tobillo en punta y mañana sales a correr con eso.":
...
"Cuando no sabes qué te dejó duro, o fue de todo un poco, el mejor uso del tiempo es un recorrido completo en vez de insistir sobre una sola zona. Vale igual para un día de gimnasio o para un día largo de trabajo.":
...
"Listo. Come algo en la próxima media hora.": "Done. Eat something in the next half hour.",
...
"Si sientes todo duro, si fue día de gimnasio, o si no quieres elegir.":
...
"¿De qué vienes?": "Você está vindo de quê?",
"Correr": "Corrida",
"Bici": "Bike",
"Nadar": "Natação",
"Triatlón": "Combinado",
...
"Listo. Come algo en la próxima media hora.": "Pronto. Coma alguma coisa na próxima meia hora.",

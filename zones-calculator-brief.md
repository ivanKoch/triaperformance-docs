...
| 8 | **The "Empieza aquí" onboarding section comes off the members home**, all three languages — it exists to point at the two pages being retired. |
...
- [x] ~~**Remove the "Empieza aquí" onboarding section** from the members home in all three languages (decision 8) — it exists only to point at the two retired pages.~~ ✅ **Already done — removed August 10, 2026**, and `site/members/index.njk` carries the comment explaining why. *Found still open September 5, 2026 during the register sweep: it had been carried as an open item for 26 days after it was executed — the "closed means closed" failure this repo has a rule about.* **And it was found by accident**, because the item happened to quote the section by its old voseo name. *Nothing was checking it.*

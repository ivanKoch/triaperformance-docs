...
> **Availability, because both dates are gates and neither is negotiable:** *the log starts* **2026-09-05**, *so the first complete* **WAU** *window closes* **September 12** *and the first complete* **MAU** *window closes* **October 5.** ***There is no history before September 5 and none can be reconstructed*** — *`access_count` cannot be decomposed into months. The September close therefore reports a partial month and says so; October is the first honest MAU.*
